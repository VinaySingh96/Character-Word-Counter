...
export default function Textbox() {
  ...
  return (
    <>
      ...
      <button className="btn btn-success my-3 " onClick={toUpper} >To Uppercase</button>
      <button className="btn btn-success my-3 mx-3" onClick={toLower} >To Lowercase</button>
      <button className="btn btn-success my-3 " onClick={clearText} >Clear Text</button>
